          ...
          <article>
            ...
            <CollapsibleSection title="2. Information We Collect">
              ...
              <ul className="ml-4 list-inside list-disc space-y-2 text-muted-foreground">
                <li>
                  ...
                  including IP address and user agent (browser/device
                  information) for security and authentication purposes.
                </li>
                <li>
                ...
                <li>
                  <strong>Security Data:</strong> We use Cloudflare Turnstile
                  for bot protection, which may collect certain technical
                  information to verify legitimate users.
                </li>
              </ul>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="6. Data Security">
              <p className="text-muted-foreground leading-relaxed">
                ...
                These measures include encryption, secure authentication
                protocols, and regular security assessments. However, no method
            ...
            <CollapsibleSection title="7. Your Rights and Choices">
              ...
              <ul className="ml-4 list-inside list-disc space-y-2 text-muted-foreground">
                <li>
                  ...
                  profile information at any time through your account settings
                </li>
                <li>
              ...
              <p className="text-muted-foreground leading-relaxed">
                If you signed in using Facebook, you can request deletion of
                your data through Facebook&apos;s data deletion process. When
                you submit a deletion request through Facebook, we will:
              </p>
              <ul className="ml-4 list-inside list-disc space-y-2 text-muted-foreground">
                <li>
                  Verify the deletion request using Facebook&apos;s signed
                  request mechanism
                </li>
                <li>
                ...
                <li>
                  Provide Facebook with a confirmation URL where you can check
                  the status of your deletion request
                </li>
              </ul>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="9. Children&apos;s Privacy">
              <p className="text-muted-foreground leading-relaxed">
                ...
                immediately, and we will delete such information from our
                records.
              </p>
            </CollapsibleSection>
