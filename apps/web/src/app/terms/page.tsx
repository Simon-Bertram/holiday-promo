          ...
          <article>
            ...
            <CollapsibleSection title="2. Account Registration">
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                You must be at least 13 years old to create an account. We
            ...
            <CollapsibleSection title="3. Use of Service">
              ...
              <ul className="ml-4 list-inside list-disc space-y-2 text-muted-foreground">
                ...
                <li>
                  Reproduce, duplicate, copy, or resell any portion of the
                  service
                </li>
                <li>
            ...
            <CollapsibleSection title="4. Deals and Promotions">
              <p className="text-muted-foreground leading-relaxed">
                We provide information about holiday deals and promotional
                offers from third-party providers. We do not guarantee the
                availability, quality, or accuracy of these deals. All deals are
                subject to the terms and conditions set by the respective
                providers. We are not responsible for any transactions between
                you and third-party providers, including but not limited to
                booking issues, payment disputes, or service quality. Always
                review the terms and conditions of any deal or promotion before
                making a purchase.
              </p>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="5. Intellectual Property">
              <p className="text-muted-foreground leading-relaxed">
                ...
                distribute, create derivative works, publicly display, or in any
                way exploit any of the content available through the service
            ...
            <CollapsibleSection title="6. Disclaimers">
              ...
              <ul className="ml-4 list-inside list-disc space-y-2 text-muted-foreground">
                ...
                <li>
                  ...
                  availability of any deals or promotions
                </li>
              </ul>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="7. Limitation of Liability">
              <p className="text-muted-foreground leading-relaxed">
                ...
                the service. Our total liability for any claims arising from or
            ...
            <CollapsibleSection title="8. Termination">
              <p className="text-muted-foreground leading-relaxed">
                ...
                deleting it through your account settings or by contacting us.
              </p>
            </CollapsibleSection>
