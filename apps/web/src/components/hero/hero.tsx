...
export default function Hero() {
  return (
    <div className="relative grid min-h-dvh w-full grid-cols-12 grid-rows-8">
      ...
      />
      <div className="z-10 col-start-2 col-end-12 row-start-5 row-end-8 flex flex-col rounded-lg bg-black/70 p-6 text-white md:col-start-8 md:col-end-13 md:row-start-6 md:row-end-8">
        <h1 className="mb-4 font-black text-3xl md:text-5xl">
